...
const AdminCredits = () => {
  ...
  try {
    ...
    // 1. Update the LocalStorage data
    const storageUser = JSON.parse(localStorage.getItem("user"));
    storageUser.credits = res.data.newAdminBalance; // From the new backend response
    localStorage.setItem("user", JSON.stringify(storageUser));

    // 2. Trigger a "storage" event manually so the Header updates instantly
  ...
  return (
    <div className="max-w-2xl">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h2 className="text-2xl font-bold text-zinc-800">Assign Credits</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {/* Form Section */}
        <form className="md:col-span-2 space-y-6" onSubmit={handleAssign}>
          {/* User ID Input */}
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full bg-zinc-50 border border-zinc-200 rounded-xl p-3 text-sm focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all outline-none font-mono"
              value={credits}
        ...
        <div className="space-y-4">
          <div className="bg-zinc-50 border border-zinc-100 rounded-2xl p-5">
            ...
            <ul className="space-y-3">
              <li className="text-xs text-zinc-600 leading-relaxed flex gap-2">
